        ...
        >
          <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-8 lg:text-left">
            <motion.div
              ...
              className="inline-flex items-center px-3 py-1 rounded-full border border-purple-700 bg-purple-900/30 text-purple-300 text-sm font-medium mb-6"
            >
            ...
            <motion.p
              variants={itemVariants}
              className="mt-6 text-base text-slate-400 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0"
            >
              With 1.5+ years of experience designing and
              developing scalable, high-performance web applications.
              Specialized in building responsive platforms using React, Python,
              FastAPI, and MongoDB.
            </motion.p>

            <motion.div
              variants={itemVariants}
              className="mt-6 flex flex-wrap gap-4 text-slate-400 text-sm font-medium sm:justify-center lg:justify-start"
            >
